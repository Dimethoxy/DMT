...
class RotarySlider : public juce::Slider {
  ...
  //==============================================================================
public:
  enum class Type { Positive, Negative, Bipolar, Selector };
  RotarySlider(Type type) : juce::Slider(), type(type) {
...
private:
  ...
  void drawSlider(juce::Graphics &g,
    ...
    const float rawAngle = juce::jmap(value, minValue, maxValue,
    ...
    const auto lowerRail = getLowerRail(centre, railRadius, startAngleInRadians,
                                        endAngleInRadians);
    g.setColour(lowerRailColour);
    g.strokePath(lowerRail, strokeType);

    // Draw the upper rail
    const auto upperRail = getUpperRail(centre, railRadius, startAngleInRadians,
                                        endAngleInRadians, valueAngleInRadians);
  ...
  //============================================================================
  void drawSelectorDots(juce::Graphics &g, const juce::Rectangle<float> &bounds,
                        const float arcRadius, const float startAngleInRadians,
                        const float endAngleInRadians, const int numDots,
  ...
  //============================================================================
  const juce::Path
  getUpperRail(const juce::Point<float> &centre, const float arcRadius,
               const float startAngleInRadians, const float endAngleInRadians,
    ...
    case Type::Positive:
      arc.addCentredArc(centre.getX(), centre.getY(), arcRadius, arcRadius,
                        0.0f, startAngleInRadians, valueAngleInRadians, true);
      break;
    case Type::Negative:
      arc.addCentredArc(centre.getX(), centre.getY(), arcRadius, arcRadius,
                        0.0f, endAngleInRadians, valueAngleInRadians, true);
      break;
    case Type::Bipolar:
      auto centreValue = (endAngleInRadians - startAngleInRadians) / 2.0f;
      arc.addCentredArc(centre.getX(), centre.getY(), arcRadius, arcRadius,
                        0.0f, startAngleInRadians + centreValue,
                        valueAngleInRadians, true);
      break;
    }
    return arc;
  }
  ...
  const juce::Path getLowerRail(const juce::Point<float> &centre,
                                float arcRadius, float startAngleInRadians,
                                float endAngleInRadians) const noexcept {
    juce::Path arc;
    arc.addCentredArc(centre.getX(), centre.getY(), arcRadius, arcRadius, 0.0f,
                      startAngleInRadians, endAngleInRadians, true);
    return arc;
  }
  //============================================================================
