...
envelopeParameterGroup(juce::String suffix)
{
  ...
  return juce::AudioProcessorParameterGroup(
    suffix + "EnvelopeParameters",                             // group ID
    "Envelope Parameters",                                     // group name
    "|",                                                       // separator
    std::make_unique<ParameterFloat>("attack",                 // parameter ID
                                     ...
                                     NormalisableRange(0.0f,   // rangeStart
                                                       ...
                                                       0.5f),  // skewFactor
                                     0.0f),                    // defaultValue
    std::make_unique<ParameterFloat>("hold",                   // parameter ID
                                     "Hold",                   // parameter name
                                     NormalisableRange(0.0f,   // rangeStart
                                                       1.0f,   // rangeEnd
                                                       0.001f, // intervalValue
                                                       0.5f),  // skewFactor
                                     0.08f),                   // defaultValue
    std::make_unique<ParameterFloat>("decay",                  // parameter ID
                                     ...
                                     NormalisableRange(0.0f,   // rangeStart
                                                       ...
                                                       0.5f),  // skewFactor
                                     0.5f),                    // defaultValue
    std::make_unique<ParameterFloat>("scew",                   // parameter ID
                                     "Scew",                   // parameter name
                                     NormalisableRange(0.0f,   // rangeStart
                                                       32.0f,  // rangeEnd
                                                       0.1f,   // intervalValue
